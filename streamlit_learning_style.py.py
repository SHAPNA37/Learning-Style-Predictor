# -*- coding: utf-8 -*-
"""
Created on Mon Jul 28 13:51:05 2025
...
model = joblib.load("xxgb_learning_style_model.joblib")
scaler = joblib.load("scaler_learning_style.joblib")
label_encoder = joblib.load("label_encoder_learning_style.joblib")
...
- Fidget tools: Allow the use of discreet fidget tools if it aids concentration.
    ...
    #  Teacher-Focused Visualizations Section
    st.markdown("---")
    ...
    fig_radar = go.Figure()
    fig_radar.add_trace(go.Scatterpolar(r=radar_values, theta=labels, fill='toself', name='Student Profile', line_color='royalblue'))
